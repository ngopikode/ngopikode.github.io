        ...
        <footer id="footer" className="footer">
                ...
                <div className="container">
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-2 col-md-3 footer-links">
                            <h4>Our Services</h4>
                            <ul>
                                <li><i className="bi bi-chevron-right"></i> <a href="#"> Creative Tech Solutions</a>
                                </li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#"> EdTech & Personal
                                    Development</a></li>
                                <li><i className="bi bi-chevron-right"></i> <a href="#"> Digital Solutions for UMKM</a>
                                </li>
            ...
            <div className="copyright">
                <div className="container text-center">
                    <p>© <span>All Rights Reserved</span><strong className="px-1 sitename">SINERGI KODE KREATIF,
                        PTP</strong></p>
                    <div className="credits">
                        ...
                        <a href="https://www.ngopikode.my.id/" className="ms-1">
                            ...
                            <img
                                ...
                                alt="Sinergi Kode Kreatif, PTP Logo" width="24" height="24"
